...
class Request
{
     ...
     *
     * Suppose that an index.html file instantiates this request object:
     *
     *  * http://localhost/index.html         returns an empty string
     *  * http://localhost/index.html/page    returns an empty string
     *  * http://localhost/web/index.html     returns '/web'
     *  * http://localhost/we%20b/index.html  returns '/we%20b'
     *
     * @return string The raw path (i.e. not urldecoded)
     *
     * @api
     ...
     * script filename (e.g. index.html) if one exists.
     *
